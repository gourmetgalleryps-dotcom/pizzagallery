...
function ProductCard({ product }) {
  ...
  return (
    <div className="group relative flex flex-col p-3 bg-white backdrop-blur-sm rounded-2xl border border-[#88f59b]/20 md:hover:-translate-y-1 md:hover:shadow-xl md:hover:shadow-[#88f59b]/30 md:hover:border-[#88f59b] md:hover:bg-[#88f59b]/5 transition-all duration-300">
...
export default function TruckPizzaWebsite() {
  ...
  return (
    <CartProvider>
      <div className="min-h-screen bg-gradient-to-br from-[#88f59b]/5 via-white to-[#88f59b]/5 text-slate-900">
        {/* Header */}
        <header className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#88f59b]/20 shadow-sm">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center gap-8">
                <a href="#menu" className="text-gray-700 hover:text-[#88f59b] transition-colors">Menu</a>
                <a href="#about" className="text-gray-700 hover:text-[#88f59b] transition-colors">About</a>
                <a href="#location" className="text-gray-700 hover:text-[#88f59b] transition-colors">Location</a>
                <button 
        ...
        {/* Hero Section */}
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-[#88f59b]/10 via-white to-[#88f59b]/5">
          ...
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#88f59b]/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#88f59b]/15 rounded-full blur-3xl"></div>
          ...
          <div className="relative z-10 text-center px-6 max-w-5xl">
            ...
            <h1 className="text-6xl md:text-9xl font-black mb-6 tracking-tight">
              ...
              <br />
              <span className="text-slate-900">PIZZA</span>
            </h1>
        ...
        {/* Stats Section */}
        <section className="py-16 px-6 bg-gradient-to-r from-[#88f59b]/10 via-[#88f59b]/5 to-white relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {[
                ...
                <div key={idx} className="text-center group">
                  ...
                  <div className="text-3xl md:text-5xl font-black text-slate-900 mb-2">{stat.number}</div>
        ...
        {/* Features Section */}
        <section className="py-20 px-6 relative bg-gradient-to-b from-white to-[#88f59b]/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">Experience the difference with our premium ingredients and authentic recipes</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="group bg-white backdrop-blur-sm rounded-2xl p-6 border border-[#88f59b]/20 hover:border-[#88f59b] hover:bg-[#88f59b]/5 transition-all hover:scale-105 hover:shadow-xl hover:shadow-[#88f59b]/20">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#88f59b] to-[#5fd672] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-[#88f59b]/20">
                    <feature.icon className="w-7 h-7 text-slate-900" />
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-[#88f59b] transition-colors">{feature.title}</h3>
        ...
        <section className="py-20 px-6 bg-gradient-to-br from-[#88f59b]/15 via-white to-[#88f59b]/10 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#88f59b]/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#88f59b]/20 rounded-full blur-3xl"></div>
          <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Menu Section */}
        <section id="menu" className="py-20 px-6 relative bg-gradient-to-b from-[#88f59b]/5 to-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-5xl md:text-6xl font-black mb-4">Our Menu</h2>
              <p className="text-gray-600 text-lg">Handcrafted pizzas made fresh daily</p>
            </div>
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-full font-semibold transition-all ${
                    selectedFilter === filter.id
                      ...
                      : 'bg-white text-gray-700 hover:bg-[#88f59b]/10 border border-[#88f59b]/30 hover:border-[#88f59b]'
                  }`}
                >
                  {filter.label}
        ...
        <section className="py-20 px-6 relative overflow-hidden bg-gradient-to-b from-white to-[#88f59b]/8">
          <div className="absolute inset-0 bg-gradient-to-br from-[#88f59b]/10 to-transparent"></div>
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-[#88f59b]/10 rounded-full border border-[#88f59b]/30">
              ...
              <p className="text-gray-600 text-lg">Real reviews from real pizza lovers</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="bg-white backdrop-blur-sm rounded-2xl p-6 border border-[#88f59b]/20 hover:border-[#88f59b] hover:bg-[#88f59b]/5 transition-all hover:scale-105 shadow-sm">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#88f59b] to-[#5fd672] flex items-center justify-center text-slate-900 font-bold shadow-md shadow-[#88f59b]/20">
                      {testimonial.avatar}
                    </div>
                    <div>
        ...
        {/* Gallery Section */}
        <section className="py-20 px-6 bg-gradient-to-br from-[#88f59b]/8 via-white to-[#88f59b]/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-[#88f59b]/10 rounded-full border border-[#88f59b]/30">
              ...
              <p className="text-gray-600 text-lg">A visual feast of our mouth-watering pizzas</p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
                <div key={item} className="group relative aspect-square rounded-2xl overflow-hidden border border-[#88f59b]/20 hover:border-[#88f59b] transition-all hover:scale-105 bg-white shadow-sm hover:bg-[#88f59b]/5">
                  <div className="w-full h-full bg-gradient-to-br from-[#88f59b]/10 to-[#88f59b]/5 flex items-center justify-center">
                    <Pizza className="w-16 h-16 text-[#88f59b] opacity-40 group-hover:opacity-60 transition-opacity" />
                  </div>
        ...
        {/* Location Info */}
        <section id="location" className="py-20 px-6 bg-gradient-to-b from-white to-[#88f59b]/10">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-black text-center mb-12">Find Us</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-white to-[#88f59b]/5 rounded-2xl p-8 text-center hover:scale-105 transition-transform border border-[#88f59b]/20 hover:border-[#88f59b] hover:bg-[#88f59b]/10 shadow-sm">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#88f59b] to-[#5fd672] flex items-center justify-center mx-auto mb-4 shadow-lg shadow-[#88f59b]/20">
                  <MapPin className="w-8 h-8 text-slate-900" />
                </div>
                <h3 className="text-xl font-bold mb-2 text-slate-900">Location</h3>
                <p className="text-gray-600">Downtown & Main Street<br />Check our live location</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-white to-[#88f59b]/5 rounded-2xl p-8 text-center hover:scale-105 transition-transform border border-[#88f59b]/20 hover:border-[#88f59b] hover:bg-[#88f59b]/10 shadow-sm">
                ...
                <p className="text-gray-600">Mon-Fri: 11AM - 10PM<br />Sat-Sun: 12PM - 11PM</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-white to-[#88f59b]/5 rounded-2xl p-8 text-center hover:scale-105 transition-transform border border-[#88f59b]/20 hover:border-[#88f59b] hover:bg-[#88f59b]/10 shadow-sm">
                ...
                <p className="text-gray-600">(555) PIZZA-01<br />Pre-order available</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Contact Section */}
        <section className="py-20 px-6 relative overflow-hidden bg-gradient-to-br from-[#88f59b]/10 via-white to-[#88f59b]/5">
          <div className="absolute inset-0 bg-gradient-to-br from-[#88f59b]/5 to-white"></div>
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="bg-white backdrop-blur-sm rounded-2xl p-6 border border-[#88f59b]/20 hover:border-[#88f59b] hover:bg-[#88f59b]/5 transition-all shadow-sm">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#88f59b] to-[#5fd672] flex items-center justify-center shadow-md shadow-[#88f59b]/20">
                ...
                <div className="bg-white backdrop-blur-sm rounded-2xl p-6 border border-[#88f59b]/20 hover:border-[#88f59b] hover:bg-[#88f59b]/5 transition-all shadow-sm">
                  ...
                  <div className="flex gap-3">
                    <a href="#" className="w-10 h-10 rounded-lg bg-gray-100 hover:bg-[#88f59b] flex items-center justify-center transition-colors group">
              ...
              <div className="bg-white backdrop-blur-sm rounded-2xl p-8 border border-[#88f59b]/20 shadow-sm">
                ...
                <form className="space-y-4">
                  <div>
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 text-slate-900 placeholder-gray-400 focus:outline-none focus:border-[#88f59b] transition-colors"
                    />
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 text-slate-900 placeholder-gray-400 focus:outline-none focus:border-[#88f59b] transition-colors resize-none"
                    ></textarea>
                  </div>
                  <button
                    type="submit"
        ...
        {/* Footer */}
        <footer className="py-12 px-6 border-t border-[#88f59b]/20 bg-gradient-to-b from-white to-[#88f59b]/5">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <p className="text-gray-600 text-sm mb-4">Fresh, hot pizza delivered from our mobile kitchen. The best slice in town!</p>
                <div className="flex gap-3">
                  <a href="#" className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-[#88f59b] flex items-center justify-center transition-colors">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#menu" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">Menu</a></li>
                  <li><a href="#about" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">About Us</a></li>
                  <li><a href="#location" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">Locations</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">Contact</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">FAQ</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">Privacy Policy</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">Terms of Service</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-[#88f59b] transition-colors text-sm">Refund Policy</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    type="email"
                    placeholder="Your email"
                    className="flex-1 px-4 py-2 rounded-lg bg-gray-50 border border-gray-300 text-slate-900 placeholder-gray-400 focus:outline-none focus:border-[#88f59b] text-sm"
                  />
            ...
            <div className="pt-8 border-t border-[#88f59b]/20 text-center">
              <p className="text-gray-600 text-sm">© 2024 Pizza Gallery. All rights reserved. Made with <Heart className="w-4 h-4 inline text-[#88f59b]" /> for pizza lovers.</p>
            </div>
          </div>
        </footer>
      </div>
