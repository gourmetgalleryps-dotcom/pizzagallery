...
function ProductCard({ product }) {
  ...
  return (
    <div className="group relative flex flex-col p-3 bg-white backdrop-blur-sm rounded-2xl border border-gray-200 md:hover:-translate-y-1 md:hover:shadow-xl md:hover:shadow-[#88f59b]/20 md:hover:border-[#88f59b] transition-all duration-300">
...
export default function TruckPizzaWebsite() {
  ...
  return (
    <CartProvider>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 text-slate-900">
        {/* Header */}
        ...
        {/* Stats Section */}
        <section className="py-16 px-6 bg-gradient-to-r from-gray-50 to-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="group bg-white backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-[#88f59b] transition-all hover:scale-105 hover:shadow-xl hover:shadow-[#88f59b]/20">
        ...
        <section className="py-20 px-6 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        {/* About Section */}
        <section id="about" className="py-20 px-6 bg-gray-50 relative">
          <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="bg-white backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-[#88f59b] transition-all hover:scale-105 shadow-sm">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
                <div key={item} className="group relative aspect-square rounded-2xl overflow-hidden border border-gray-200 hover:border-[#88f59b] transition-all hover:scale-105 bg-white shadow-sm">
        ...
        <section id="location" className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 text-center hover:scale-105 transition-transform border border-gray-200 shadow-sm">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="bg-white backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-[#88f59b] transition-all shadow-sm">
